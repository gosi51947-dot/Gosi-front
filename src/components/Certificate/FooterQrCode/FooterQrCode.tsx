  ...
  return (
    <section className="flex flex-col ml-4 gap-3 text-[12px]">
      ...
      <div className="flex   gap-8 justify-between items-end">
        {/* paragraph */}
        <p className="opacity-40 text-md font-semibold">
        ...
        {/* qr code */}
        <Image src={qrCodeDataUrl} alt="qr code" className="ml-5" width={100} height={100} />
      </div>
      {/* secound colun */}
      <p className="opacity-40 text-[9px] ">
      ...
      <div className="flex gap-10 items-center  -mt-4">
        ...
        <article className="flex flex-col leading-4">
          <p className="text-[0.7rem] " dir="ltr">800 124 3344</p>
          <p className="text-secColor font-semibold">gosi.gov.sa</p>
        </article>
