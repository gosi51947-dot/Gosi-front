  ...
  return (
    <section className="flex flex-col ml-4 gap-3 text-[12px]">
      ...
      <div className="flex   gap-2 justify-between items-end">
        {/* paragraph */}
        <p className="opacity-40 text-[11.5px] whitespace-nowrap  font-semibold ">
          ﺗﺤﻘﻖ ﻣﻦ ﺻﺤﺔ ﻭﺻﻼﺣﻴﺔ ﺍﻟﺸﻬﺎﺩﺓ ﻋﺒﺮ ﺯﻳﺎﺭﺓ ﺍﻟﺮﺍﺑﻂ ﺃﺩﻧﺎﻩ ﻓﻲ ﺍﻟﻤﻮﻗﻊ ﺍﻻﻟﻜﺘﺮﻭﻧﻲ
          ﻟﻠﻤﺆﺳﺴﺔ ﺍﻟﻌﺎﻣﺔ  <br/>ﻟﻠﺘﺄﻣﻴﻨﺎﺕ ﺍﻻﺟﺘﻤﺎﻋﻴﺔ ﺍﻭ ﻋﻦ ﻃﺮﻳﻖ ﺍﺳﺘﺨﺪﺍﻡ ﺍﻟﺮﻣﺰ ﺍﻟﻤﻌﺮﻑ
          ﺍﻟﺘﺎﻟﻲ
        </p>
        {/* qr code */}
        <Image
      ...
      <p className="opacity-40 text-[8.8px] mr-1 text-[#818895] whitespace-nowrap">
        ...
        بياناتها أو غير ذلك من أنواع التعديل, 
        </span>
        <br/>
        <span className="text-[8.5px]">
        وتعد الشهادة لاغية إذا شابها شي من
        ذلك. كما تعرض صاحبها للملاحقة النظامية أمام الجهات المختصة بالإضافة إلى
        ما يفرضه نظام التأمينات الاجتماعية من عقوبات، ولا يجوز تداول الشهادة
        </span>
         <br/>
         <span className="text-[8.3px]">
        إلا
        في الأغراض التي أصدرت لأجلها وفقاً لأحكام نظام التأمينات الاجتماعية
        والمؤسسة العامة للتأمينات الاجتماعية غير مسؤولة عن أي عملية تزوير أو
        تعديل تتم على البيانات الواردة فيها.
         </span>
      </p>
